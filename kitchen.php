    ...
    <div class="row flex">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="kitchen.php">POS</a></li>
        ...
        <div class="col-8  flex-grow-1" style="background-image:url('IMAGES/background.jpg');background-attachment:fixed; background-size:cover;background-repeat: no-repeat;">
            <main class="container">
                <h1 class="text-center my-1" style="font-family:Helvetica; font-size:70px;"><b>KITCHEN UTENSILS STORE</b>
                </h1>
                <div class="">
                    <!-- dropdown -->
                    <div class="px-3">
                        <div class="btn-group bg-white">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="kitchen.php" style="color: blue;">Kitchen Utensils</a>
                                </li>
                    ...
                    <div class="row mx-auto row-cols-5">
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            $label = "Kitchen Utensil $i";
                            $price = "$Kitchen[$i]";
                            echo "
                            <div class='col'onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-4 mx-3 ' style='width: 190px;'>
                                    <div class='row g-0'>
                                        <img src='kitchen_pictures/d$i.jpg' class='card-img-top rounded-start' alt='...' height='190'/>
