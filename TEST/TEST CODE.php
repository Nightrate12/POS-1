        ...
        <ul class="list-group">
            ...
            <li class="list-group-item border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" id="Quantity" min="1" onchange="updatePrice()">
                    </div>
            </li>
            <li class="list-group-item border-0">
                <div class="row align-items-center">
...
<script>
        ...
        function updateInputBoxes(checkboxId, itemName, itemPrice) {
            ...
            if (checkbox.checked) {
                ...
                // Calculate and set the price based on quantity and itemPrice
...
function updateTotalPrice() {
    ...
    document.getElementById('Discounted').value = (discountedPricePerItem * quantity).toFixed(2);
}
