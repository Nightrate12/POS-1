    ...
    <div class="row flex">
        ...
        <div class="col-8  flex-grow-1"
            ...
            <main class="container">
                <h1 class="text-center my-1" style="font-family:Helvetica; font-size:70px;"><b>KITCHEN UTENSILS
                        STORE</b>
                </h1>
                <div class="">
                    <!-- dropdown -->
                    <div class="px-3">
                        <div class="btn-group bg-white">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="food.php" style="color: blue;">Food</a>
                                </li>
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            ...
                            <div class='col'onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-4 mx-3 ' style='width: 190px;'>
                                    <div class='row g-0'>
                                        <img src='foods_pictures/d$i.jpg' class='card-img-top rounded-start' alt='...' height='190'/>
                        ...
                        <div class="col-6">
                            ...
                            <div>
                                ...
                                <ul class="list-group list-group-horizontal gap-5">
                                    ...
                                    <li class="" style="list-style-type: none;"> <input class="form-check-input"
                                            type="radio" name="flexRadioDefault" id="No discount"
